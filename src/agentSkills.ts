...
- COMPACT SCENE TEMPLATE: every scene must contain exactly 5 concise lines: (1) "Create a vertical 9:16 realistic TikTok Shop affiliate fashion video using Keyframe X as the start frame and Keyframe Y as the end frame.", (2) ACTION, (3) CAMERA, (4) LOCKS, and (5) CLEAN. Never paste or repeat the Master Prompt, Model Lock, Product Lock, Background Lock, Camera Style, or Continuity Rule inside a scene.
